...
export function DeliveryStatsQuery() {
  const { data: statsResponse, isLoading, isError, refetch, isFetching } = useDeliveryStats()

  if (isLoading) {
    return <div className="mb-8 h-96 animate-pulse rounded-lg bg-zinc-200"></div>
  }

  if (isError || !statsResponse?.success || !statsResponse.data) {
    return null
  }
    ...
    <div className="mb-8">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-6 shadow-sm">
            ...
            <p className="mt-2 text-xs text-zinc-600">Mês passado: {formatCurrency(earnings.lastMonth)}</p>
          </div>
          ...
          <div className="rounded-lg bg-gradient-to-br from-blue-500 to-violet-600 p-6 text-white shadow-md">
            ...
            <p className="mt-2 text-xs opacity-80">Baseado no ritmo atual</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-4 shadow-sm">
              <p className="mb-3 text-sm font-medium text-zinc-700">Entregas semanais</p>
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-4 shadow-sm">
              <p className="mb-3 text-sm font-medium text-zinc-700">Entregas mensais</p>
              <div className="flex items-center justify-between">
                <div>
